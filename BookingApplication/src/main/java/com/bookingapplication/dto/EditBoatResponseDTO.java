...
public class EditBoatResponseDTO {
    private long id;
    private String name;
    ...
    public EditBoatResponseDTO(long id, String name, String address, String description, String rules, ImagesDTO boatImages, Double latitude, Double longitude) {
        this.id = id;
        this.name = name;
    ...
    public EditBoatResponseDTO(Boat boat, ImagesDTO boatImages){
