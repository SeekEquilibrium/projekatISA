...
@Component({
    selector: "app-boat-define-actions",
    templateUrl: "./boat-define-actions.component.html",
    styleUrls: ["./boat-define-actions.component.css"],
})
export class BoatDefineActionsComponent implements OnInit {
    ...
    constructor(
        public dialogRef: MatDialogRef<BoatDefineActionsComponent>,
    ...
    ngOnInit() {
        this.boatService.getBoatActions(this.data.boatId).subscribe(
            (response) => {
